...
El resultado no pretende sustituir a una plataforma ITSM comercial, sino demostrar de forma reproducible cómo integrar automatización, seguridad y operación cloud en un caso empresarial acotado. La memoria expone las decisiones tomadas, las alternativas consideradas y la evolución de la persistencia desde un blob JSON inicial hasta una base de datos documental en Cosmos DB, más adecuada para separar solicitudes y evitar concentrar toda la colección en un único objeto.
\end{abstract}
