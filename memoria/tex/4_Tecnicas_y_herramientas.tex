...
La infraestructura cloud se basa en Microsoft Azure y en servicios gestionados documentados por Microsoft para aplicaciones web, almacenamiento, monitorización y gestión de secretos \cite{azure_appservice_python_quickstart,azure_blob_python,azure_appservice_keyvault_refs,azure_monitor}.
