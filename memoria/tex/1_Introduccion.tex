...
La arquitectura propuesta utiliza una API desarrollada en Python y Flask desplegada sobre Azure App Service, integrando además servicios como Azure Storage, Azure Key Vault, Azure Logic Apps y herramientas de automatización y calidad como GitHub Actions y SonarCloud.
