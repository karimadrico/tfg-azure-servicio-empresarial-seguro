...
- Valoración de solicitudes cerradas y promedio de satisfacción.
...
- Gestión del ciclo de vida de solicitudes desde el portal.
- Integración de Logic App y Application Insights.
- Evidencias finales de Azure, Zube, GitHub y SonarCloud.
- Memoria y anexos revisados como candidata de entrega.

## [1.0.0] - 2026-06-18

### Añadido

- Portal web y API Flask desplegados en Azure App Service.
- Clasificación automática ligera de solicitudes.
- Persistencia en Azure Blob Storage.
- Secreto Bearer en Key Vault y acceso mediante Managed Identity.
